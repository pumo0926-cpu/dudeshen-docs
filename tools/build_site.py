...
DOCS=[
 ...
 ("11-初中生体验的最大流失风险.md","11","初中生体验的最大流失风险","实测：一篇 6 个输入框、0 次反馈、2 道灰按钮——最大流失点在第 3 步"),
 ("12-答题动线审计-阻碍点与体验损耗.md","12","答题动线审计：阻碍点与体验损耗","从初中生答题视角倒查 9 个卡点，抽出三条交互红线"),
]
...
<strong>想知道最近改了什么：</strong>10（教材全国统一、出题风格才是地区变量；课内篇目放原文与版权处理）。<br>
<strong>最该先看的一篇：</strong>11（体验实测：最大流失点与最小改动方案）。</blockquote>
